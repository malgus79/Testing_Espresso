...
import com.myespresso.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getProductFromServer(): Product = Product(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Finca_Solano_Tempranillo_" +
                "Crianza.jpg/360px-Finca_Solano_Tempranillo_Crianza.jpg",
        343,
        1,
        74.99,
        "njk3n4jk3n")
